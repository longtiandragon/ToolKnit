...
.markdown-insert-dialog>header>div{display:grid;gap:4px}.markdown-insert-dialog>header p{margin:0;color:var(--green-strong);font:700 11px var(--font-mono);letter-spacing:.1em}.markdown-insert-dialog>header h2{margin:0;font:710 22px/1.3 var(--font-display);letter-spacing:-.025em}.markdown-insert-dialog>header span{color:var(--muted);font-size:11px;line-height:1.55}
...
.markdown-table-header-toggle{display:flex;align-items:flex-start;gap:9px;padding:11px;border:1px solid var(--line-weak);border-radius:9px;background:var(--surface-2)}.markdown-table-header-toggle input{margin-top:2px;accent-color:var(--green)}.markdown-table-header-toggle>span{display:grid;gap:3px}.markdown-table-header-toggle b{font-size:11px}.markdown-table-header-toggle small{color:var(--muted);font-size:11px;line-height:1.45}
.markdown-table-controls fieldset{display:grid;gap:7px;margin:0;padding:0;border:0}.markdown-table-controls legend{margin-bottom:7px}.markdown-segments{display:flex;width:max-content;max-width:100%;padding:3px;border:1px solid var(--line);border-radius:8px;background:var(--surface-2)}.markdown-segments button{min-height:28px;padding:0 10px;border:0;border-radius:6px;color:var(--muted);background:transparent;font:650 11px var(--font-ui)}.markdown-segments button.active{color:var(--green-strong);background:var(--surface);box-shadow:0 1px 4px var(--accent-soft)}
.markdown-table-preview,.markdown-formula-preview{display:grid;min-width:0;align-content:start;gap:13px;padding:15px;border:1px solid var(--accent-soft);border-radius:11px;background:linear-gradient(145deg,var(--surface-2),var(--surface-2))}.markdown-table-preview>header,.markdown-formula-preview>header{display:flex;align-items:center;justify-content:space-between;color:var(--text-secondary);font:700 11px var(--font-mono);letter-spacing:.04em}.markdown-table-preview code,.markdown-formula-preview code{color:var(--green-strong);font:700 11px var(--font-mono)}.markdown-table-preview__grid{display:grid;gap:3px;min-height:132px;align-content:center}.markdown-table-preview__grid i{display:grid;min-height:22px;place-items:center;border:1px solid var(--accent-soft);border-radius:3px;background:var(--surface-2);color:var(--muted);font:700 11px var(--font-mono);font-style:normal}.markdown-table-preview__grid i.head{border-color:var(--accent-soft);color:var(--green-strong);background:var(--accent-soft)}.markdown-table-preview>small,.markdown-formula-preview>small{color:var(--muted);font-size:11px;line-height:1.5}
.markdown-formula-mode{margin-bottom:1px}.markdown-formula-editor textarea{box-sizing:border-box;width:100%;min-height:134px;resize:vertical;padding:11px 12px;border:1px solid var(--line-strong);border-radius:9px;outline:0;color:var(--accent);background:var(--surface);font:11px/1.65 var(--font-mono)}.markdown-formula-editor textarea:focus{border-color:var(--green);box-shadow:0 0 0 3px var(--accent-soft)}.markdown-formula-snippets{display:flex;flex-wrap:wrap;gap:6px}.markdown-formula-snippets button{min-height:29px;padding:0 9px;border:1px solid var(--line);border-radius:7px;color:var(--text-secondary);background:var(--surface);font:620 11px var(--font-ui)}.markdown-formula-snippets button:hover,.markdown-formula-snippets button:focus-visible{border-color:var(--accent-soft);color:var(--green-strong);background:var(--green-bg)}
.formula-vision-card{grid-column:1/-1;overflow:hidden;border:1px solid var(--accent-soft);border-radius:11px;background:var(--surface-2)}.formula-vision-card.open{border-color:var(--accent-soft);background:var(--surface-2)}.formula-vision-toggle{display:flex;width:100%;min-height:43px;align-items:center;justify-content:space-between;padding:0 13px;border:0;color:var(--text-secondary);background:transparent}.formula-vision-toggle>span{display:flex;align-items:center;gap:7px}.formula-vision-toggle b{font:690 11px var(--font-ui)}.formula-vision-toggle small{padding-left:7px;border-left:1px solid var(--line);color:var(--muted);font:11px var(--font-ui)}.formula-vision-toggle i{color:var(--green-strong);font:normal 16px var(--font-ui)}
.formula-vision-body{display:grid;grid-template-columns:minmax(210px,.9fr) minmax(240px,1.1fr);gap:10px;padding:0 12px 12px;border-top:1px solid var(--line-weak)}.formula-vision-input{position:absolute;width:1px;height:1px;overflow:hidden;opacity:0;pointer-events:none}.formula-image-picker,.formula-image-preview{display:flex;min-height:86px;align-items:center;gap:11px;margin-top:11px;padding:10px;border:1px dashed var(--accent-soft);border-radius:9px;color:var(--text-secondary);background:var(--surface);text-align:left}.formula-image-picker:hover,.formula-image-preview:hover{border-color:var(--green);background:var(--green-bg)}.formula-image-picker>span,.formula-image-preview>span{display:grid;min-width:0;gap:4px}.formula-image-picker b,.formula-image-preview b{overflow:hidden;font:670 11px var(--font-ui);text-overflow:ellipsis;white-space:nowrap}.formula-image-picker small,.formula-image-preview small{color:var(--muted);font:11px/1.45 var(--font-ui)}.formula-image-preview img{width:78px;height:62px;flex:0 0 auto;object-fit:contain;border:1px solid var(--line-weak);border-radius:6px;background:var(--surface)}
.formula-vision-control{display:grid;align-content:center;gap:8px;margin-top:11px}.formula-vision-control label{display:grid;gap:5px}.formula-vision-control label>span{color:var(--text-secondary);font:680 11px var(--font-ui)}.formula-vision-control select{box-sizing:border-box;width:100%;min-height:34px;padding:0 9px;border:1px solid var(--line-strong);border-radius:8px;color:var(--text);background:var(--surface);font:11px var(--font-ui)}.formula-vision-control>.primary-button{display:inline-flex;min-height:34px;align-items:center;justify-content:center;gap:7px;margin:0}.formula-vision-control p{margin:0;color:var(--muted);font:11px/1.55 var(--font-ui)}.formula-vision-control a{color:var(--green-strong)}.formula-vision-privacy,.formula-vision-error{grid-column:1/-1;display:flex;align-items:flex-start;gap:6px;margin:0;padding:8px 9px;border-radius:7px;color:var(--muted);background:var(--accent-soft);font:11px/1.5 var(--font-ui)}.formula-vision-error{color:var(--danger);background:var(--danger-soft)}
.formula-image-menu{position:fixed;z-index:380;display:grid;width:184px;padding:5px;border:1px solid var(--accent-soft);border-radius:9px;background:var(--surface);box-shadow:0 14px 36px var(--line-strong)}.formula-image-menu button{display:flex;min-height:33px;align-items:center;gap:8px;padding:0 9px;border:0;border-radius:6px;color:var(--text-secondary);background:transparent;font:11px var(--font-ui);text-align:left}.formula-image-menu button:hover,.formula-image-menu button:focus-visible{color:var(--green-strong);background:var(--green-bg)}.formula-image-menu button.danger{color:var(--danger)}.formula-image-menu button.danger:hover,.formula-image-menu button.danger:focus-visible{background:var(--danger-soft)}
...
.markdown-insert-dialog>footer{display:flex;min-height:64px;align-items:center;justify-content:space-between;gap:16px;padding:11px 24px;border-top:1px solid var(--line-weak);background:var(--surface-2)}.markdown-insert-dialog>footer>span{color:var(--muted);font:11px var(--font-ui)}.markdown-insert-dialog>footer kbd{padding:2px 5px;border:1px solid var(--line);border-radius:4px;background:var(--surface);font:11px var(--font-mono)}.markdown-insert-dialog>footer>div{display:flex;gap:8px}.markdown-insert-dialog>footer button{min-height:34px;margin:0;padding:0 14px;font-size:11px}
