...
.vault-restore-review>header{display:grid;grid-template-columns:42px minmax(0,1fr) auto;align-items:start;gap:13px}.vault-restore-review>header>span{display:grid;width:40px;height:40px;place-items:center;border:1px solid var(--accent-soft);border-radius:11px;color:var(--accent);background:var(--surface-2)}.vault-restore-review>header p,.vault-restore-review__archive span{color:var(--fg-2);font:700 11px var(--font-mono);letter-spacing:.08em}.vault-restore-review h3{margin:4px 0 0;color:var(--accent);font:720 20px/1.25 var(--font-display);letter-spacing:-.02em}.vault-restore-review>header small{display:block;margin-top:5px;color:var(--fg-2);font:11px/1.55 var(--font-ui)}.vault-restore-review>header>b{padding:5px 8px;border:1px solid var(--accent-soft);border-radius:999px;color:var(--accent);background:var(--surface-2);font:700 11px var(--font-ui)}
.vault-restore-review__archive{display:grid;grid-template-columns:minmax(0,1.4fr) minmax(330px,1fr);align-items:center;gap:14px;padding:11px 12px;border:1px solid var(--accent-soft);border-radius:11px;background:var(--surface-2)}.vault-restore-review__archive>div{display:grid;min-width:0;gap:3px}.vault-restore-review__archive b{overflow:hidden;color:var(--fg);font:700 12px var(--font-ui);text-overflow:ellipsis;white-space:nowrap}.vault-restore-review__archive small{color:var(--fg-2);font:11px var(--font-ui)}.vault-restore-review__archive dl{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:6px;margin:0}.vault-restore-review__archive dl>div{display:grid;gap:3px}.vault-restore-review__archive dt{color:var(--fg-3);font:11px var(--font-mono)}.vault-restore-review__archive dd{margin:0;color:var(--fg);font:700 11px var(--font-ui)}
.vault-restore-review__comparison{display:grid;grid-template-columns:minmax(0,1fr) 28px minmax(0,1fr);align-items:center;gap:8px}.vault-restore-review__comparison>span{color:var(--fg-3);text-align:center}.vault-restore-review__comparison article{display:grid;gap:4px;padding:12px;border:1px solid var(--accent-soft);border-radius:11px;background:var(--surface-2)}.vault-restore-review__comparison article.current{border-color:var(--warn-soft);background:var(--surface-2)}.vault-restore-review__comparison article header{display:flex;justify-content:space-between}.vault-restore-review__comparison article header span{color:var(--fg);font:700 11px var(--font-ui)}.vault-restore-review__comparison article header small,.vault-restore-review__comparison article p{color:var(--fg-2);font:11px/1.4 var(--font-ui)}.vault-restore-review__comparison strong{color:var(--accent);font:760 22px var(--font-display)}.vault-restore-review__comparison article.current strong{color:var(--warn)}.vault-restore-review__comparison strong small{margin-left:5px;font:600 11px var(--font-ui)}.vault-restore-review__comparison p{margin:0}
.vault-restore-review__warning{display:flex;align-items:center;gap:9px;margin:0;padding:9px 10px;border:1px solid var(--danger-soft);border-radius:9px;color:var(--danger);background:var(--surface-2)}.vault-restore-review__warning span{display:grid;gap:2px}.vault-restore-review__warning b{font:700 11px var(--font-ui)}.vault-restore-review__warning small{font:11px/1.4 var(--font-ui)}
.vault-restore-review__checks{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:7px}.vault-restore-review__checks p{display:grid;grid-template-columns:9px minmax(0,1fr);gap:8px;margin:0;padding:9px 10px;border:1px solid var(--accent-soft);border-radius:9px;background:var(--surface-2)}.vault-restore-review__checks i{width:7px;height:7px;margin-top:3px;border-radius:50%;background:var(--accent);box-shadow:0 0 0 3px var(--accent-soft)}.vault-restore-review__checks span{display:grid;gap:2px}.vault-restore-review__checks b{color:var(--fg);font:700 11px var(--font-ui)}.vault-restore-review__checks small{color:var(--fg-2);font:11px/1.4 var(--font-ui)}
.vault-restore-review__error{display:flex;align-items:center;gap:8px;margin:0;padding:9px 10px;border:1px solid var(--danger-soft);border-radius:9px;color:var(--danger);background:var(--surface-2);font:11px/1.45 var(--font-ui)}
