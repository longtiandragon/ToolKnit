...
.large-text-editor :deep(.cm-panel.cm-search){display:flex;min-height:43px;box-sizing:border-box;align-items:center;flex-wrap:wrap;gap:5px;padding:7px 41px 7px 10px;border-bottom:1px solid var(--accent-soft);color:var(--text-secondary);background:linear-gradient(180deg,var(--surface-2),var(--surface-2));box-shadow:0 5px 14px var(--accent-soft);font:600 11px var(--font-ui)}
.large-text-editor :deep(.cm-panel.cm-search br){width:100%;height:0;flex-basis:100%}
.large-text-editor :deep(.cm-panel.cm-search input.cm-textfield){width:min(228px,31vw);min-height:29px;box-sizing:border-box;margin:0;padding:0 9px;border:1px solid var(--accent-soft);border-radius:7px;outline:0;color:var(--text);background:var(--surface);font:11px var(--font-ui)}
...
.large-text-editor :deep(.cm-panel.cm-search .cm-button){min-height:29px;margin:0;padding:0 9px;border:1px solid var(--accent-soft);border-radius:7px;color:var(--text-secondary);background:var(--surface);background-image:none;font:650 11px var(--font-ui);text-transform:none}
...
.large-text-editor :deep(.cm-panel.cm-search label){display:inline-flex;min-height:27px;align-items:center;gap:3px;margin:0!important;color:var(--muted);font:600 11px var(--font-ui);white-space:nowrap}
