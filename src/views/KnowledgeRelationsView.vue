...
.relation-graph__hero>aside{display:grid;grid-template-columns:repeat(3,1fr);align-items:stretch;border-left:1px solid var(--surface-2);}.relation-graph__hero>aside>div{display:grid;place-content:center;justify-items:center;gap:6px;border-left:1px solid var(--surface-2)}.relation-graph__hero>aside>div:first-child{border-left:0}.relation-graph__hero>aside b{font:760 31px/1 var(--font-mono)}.relation-graph__hero>aside span{font-size:11px}
.relation-graph__workspace{display:grid;grid-template-columns:292px minmax(0,1fr);gap:14px;margin-top:16px;align-items:start}.relation-graph__catalog,.relation-graph__focus{overflow:hidden;border:1px solid var(--line);border-radius:16px;background:var(--surface-2);box-shadow:0 12px 30px var(--accent-soft)}.relation-graph__catalog{position:sticky;top:18px;display:grid;grid-template-rows:auto auto auto minmax(180px,1fr) auto;max-height:calc(100vh - 116px)}.relation-graph__catalog>header{display:flex;align-items:flex-end;justify-content:space-between;padding:14px;border-bottom:1px solid var(--line-weak)}.relation-graph__catalog h3{margin-top:4px;font:700 15px var(--font-display)}.relation-graph__catalog>header>small{color:var(--muted);font:11px var(--font-mono)}.relation-graph__catalog>label{display:flex;align-items:center;gap:7px;height:38px;margin:11px 12px 7px;padding:0 10px;border:1px solid var(--line);border-radius:9px;color:var(--muted);background:var(--canvas)}.relation-graph__catalog>label:focus-within{border-color:var(--green);box-shadow:0 0 0 3px color-mix(in srgb,var(--green) 12%,transparent)}.relation-graph__catalog input{min-width:0;flex:1;border:0;outline:0;color:var(--text);background:transparent;font-size:11px}.relation-graph__catalog label button{display:grid;width:22px;height:22px;padding:0;place-items:center;border:0;color:var(--muted);background:transparent}.relation-graph__scope{display:flex;gap:4px;padding:0 12px 9px}.relation-graph__scope button{min-height:27px;padding:0 8px;border:1px solid transparent;border-radius:7px;color:var(--muted);background:transparent;font-size:11px}.relation-graph__scope button.active{border-color:var(--accent-soft);color:var(--green-strong);background:var(--green-bg)}.relation-graph__catalog>nav{overflow:auto;padding:0 7px 8px;scrollbar-width:thin}.relation-graph__catalog>nav>button{display:grid;width:100%;grid-template-columns:29px minmax(0,1fr) auto;align-items:center;gap:8px;min-height:52px;padding:7px 8px;border:1px solid transparent;border-radius:9px;color:var(--text-secondary);background:transparent;text-align:left}.relation-graph__catalog>nav>button:hover,.relation-graph__catalog>nav>button:focus-visible{color:var(--green-strong);background:var(--green-bg)}.relation-graph__catalog>nav>button.active{border-color:var(--accent-soft);color:var(--green-strong);background:linear-gradient(90deg,var(--green-bg),var(--surface-2))}.relation-graph__catalog>nav>button:focus-visible{outline:2px solid color-mix(in srgb,var(--green) 46%,transparent);outline-offset:-2px}.relation-graph__catalog>nav span{display:grid;width:29px;height:29px;place-items:center;border-radius:8px;color:var(--green-strong);background:var(--accent-soft)}.relation-graph__catalog>nav div{display:grid;min-width:0;gap:3px}.relation-graph__catalog>nav b,.relation-graph__catalog>nav small{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.relation-graph__catalog>nav b{font-size:11px}.relation-graph__catalog>nav small{color:var(--muted);font-size:11px}.relation-graph__catalog>nav i{display:grid;width:21px;height:21px;place-items:center;border-radius:50%;color:var(--green-strong);background:var(--green-bg);font:700 11px var(--font-mono);font-style:normal}.relation-graph__catalog>footer{padding:9px 12px;border-top:1px solid var(--line-weak);color:var(--muted);font-size:11px;text-align:center}.relation-graph__catalog-empty{display:grid;place-content:center;justify-items:center;gap:6px;padding:28px;color:var(--muted);text-align:center}.relation-graph__catalog-empty b{color:var(--text);font-size:11px}.relation-graph__catalog-empty span{font-size:11px}
.relation-graph__focus{min-height:520px}.relation-graph__focus-head{display:grid;grid-template-columns:48px minmax(0,1fr) auto auto;align-items:center;gap:13px;padding:18px 20px;border-bottom:1px solid var(--line);background:linear-gradient(118deg,var(--green-bg),var(--surface) 64%)}.relation-graph__focus-head:focus-visible{outline:2px solid color-mix(in srgb,var(--green) 48%,transparent);outline-offset:-2px}.relation-graph__focus-head>span{display:grid;width:48px;height:48px;place-items:center;border:1px solid var(--accent-soft);border-radius:14px;color:var(--green-strong);background:var(--surface)}.relation-graph__focus-head>div{display:grid;min-width:0;gap:3px}.relation-graph__focus-head h3{overflow:hidden;font:720 20px var(--font-display);text-overflow:ellipsis;white-space:nowrap}.relation-graph__focus-head small{color:var(--muted);font-size:11px}.relation-graph__focus-head dl{display:flex;margin:0}.relation-graph__focus-head dl>div{min-width:63px;padding:2px 12px;border-left:1px solid var(--line)}.relation-graph__focus-head dt{font:720 17px var(--font-mono)}.relation-graph__focus-head dd{margin:2px 0 0;color:var(--muted);font-size:11px}.relation-graph__focus-head>button{display:inline-flex;align-items:center;gap:5px;white-space:nowrap}
.relation-graph__threads>header{display:flex;align-items:flex-end;justify-content:space-between;padding:16px 19px 11px}.relation-graph__threads h3{margin-top:4px;font:700 14px var(--font-display)}.relation-graph__threads>header>small{color:var(--muted);font-size:11px}.relation-graph__threads>div{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px;padding:0 14px 16px}.relation-graph__threads>div>button{display:grid;grid-template-columns:36px minmax(0,1fr) auto;align-items:center;gap:10px;min-height:72px;padding:10px 11px;border:1px solid var(--line);border-radius:11px;color:var(--text-secondary);background:var(--surface-2);text-align:left}.relation-graph__threads>div>button:hover,.relation-graph__threads>div>button:focus-visible{border-color:var(--accent-soft);color:var(--green-strong);background:var(--surface)}.relation-graph__threads>div>button:focus-visible{outline:2px solid color-mix(in srgb,var(--green) 46%,transparent);outline-offset:2px}.relation-graph__threads button>span{display:grid;width:36px;height:36px;place-items:center;border-radius:10px;color:var(--green-strong);background:var(--green-bg)}.relation-graph__threads button>div{display:grid;min-width:0;gap:3px}.relation-graph__threads button small{color:var(--muted);font-size:11px}.relation-graph__threads button b,.relation-graph__threads button em{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.relation-graph__threads button b{font-size:11px}.relation-graph__threads button em{color:var(--muted);font-size:11px;font-style:normal}.relation-graph__threads button>i{display:inline-flex;align-items:center;gap:4px;padding:5px 7px;border-radius:7px;color:var(--green-strong);background:var(--green-bg);font:700 11px var(--font-ui);font-style:normal;white-space:nowrap}.relation-graph__threads button>i.variation{color:var(--warn);background:var(--warn-soft)}.relation-graph__threads button>i.prerequisite{color:var(--danger);background:var(--danger-soft)}
.relation-graph__empty{display:grid;min-height:350px;place-content:center;justify-items:center;padding:36px;text-align:center}.relation-graph__empty>span{display:grid;width:50px;height:50px;margin-bottom:11px;place-items:center;border-radius:15px;color:var(--green-strong);background:var(--green-bg)}.relation-graph__empty h3{font:720 17px var(--font-display)}.relation-graph__empty p{max-width:470px;margin:8px 0 16px;color:var(--muted);font-size:11px;line-height:1.65}.relation-graph__empty code{padding:2px 5px;border-radius:4px;color:var(--green-strong);background:var(--green-bg);font-family:var(--font-mono)}.relation-graph__empty--root{min-height:520px}.relation-graph__notice,.relation-graph__warning{display:flex;align-items:center;gap:7px;margin:0;padding:9px 13px;color:var(--warn);background:var(--warn-soft);font-size:11px}.relation-graph__notice{border-top:1px solid var(--warn-soft)}.relation-graph__warning{margin-top:11px;border:1px solid var(--warn-soft);border-radius:10px}
.relation-graph__menu{position:fixed;z-index:var(--z-context-menu);width:252px;overflow:hidden;border:1px solid var(--accent-soft);border-radius:12px;background:var(--surface);box-shadow:var(--shadow-lg);animation:relation-menu-in .14s ease-out both}.relation-graph__menu>header{display:grid;gap:3px;padding:11px 13px 9px;border-bottom:1px solid var(--line-weak);background:linear-gradient(125deg,var(--green-bg),var(--surface-2))}.relation-graph__menu>header span{color:var(--green-strong);font:700 11px var(--font-mono);letter-spacing:.08em}.relation-graph__menu>header b{overflow:hidden;font:700 12px var(--font-ui);text-overflow:ellipsis;white-space:nowrap}.relation-graph__menu>button{display:flex;width:100%;min-height:39px;align-items:center;gap:9px;padding:0 13px;border:0;border-bottom:1px solid var(--line-weak);color:var(--text-secondary);background:transparent;font:650 11px var(--font-ui);text-align:left}.relation-graph__menu>button:last-child{border-bottom:0}.relation-graph__menu>button:hover,.relation-graph__menu>button:focus-visible{color:var(--green-strong);background:var(--green-bg)}.relation-graph__menu>button:focus-visible{outline:2px solid color-mix(in srgb,var(--green) 48%,transparent);outline-offset:-2px}.relation-graph__menu>button.danger{color:var(--danger)}@keyframes relation-menu-in{from{opacity:0;transform:translateY(-4px) scale(.985)}to{opacity:1;transform:none}}
