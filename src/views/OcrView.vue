...
.ocr-hero>aside{display:grid;grid-template-rows:auto 1fr auto auto;gap:10px;padding:21px;border-left:1px solid var(--surface-2)}.ocr-hero>aside>span{display:flex;align-items:center;gap:7px;font-size:9px}.ocr-hero>aside>span i{width:7px;height:7px;box-shadow:0 0 0 4px var(--warn-soft)}.ocr-hero>aside.ready>span i{box-shadow:0 0 0 4px var(--accent-soft)}.ocr-hero>aside>b{align-self:end;font:760 31px/1 var(--font-mono);letter-spacing:-.04em}.ocr-hero>aside>small{font-size:9px;line-height:1.5}.ocr-hero>aside .quiet-button{justify-content:center;color:var(--fg);}
.ocr-error{display:flex;align-items:center;gap:9px;margin-top:12px;padding:10px 12px;border:1px solid var(--danger-soft);border-radius:10px;color:var(--danger);background:var(--surface);font-size:10px}.ocr-error span{flex:1}.ocr-error button{border:0;color:inherit;background:transparent;font-size:17px}.ocr-desktop-required{display:grid;max-width:700px;min-height:320px;place-items:center;align-content:center;gap:8px;margin:18px auto;text-align:center}.ocr-desktop-required>span{display:grid;width:58px;height:58px;place-items:center;border-radius:16px;color:var(--green-strong);background:var(--green-bg)}.ocr-desktop-required h3{font:700 20px var(--font-display)}.ocr-desktop-required>p:last-child{max-width:500px;color:var(--muted);font-size:10px;line-height:1.65}
.ocr-toolbar{display:grid;grid-template-columns:auto minmax(240px,1fr) auto;align-items:end;gap:12px;margin:14px 0;padding:12px 14px;border:1px solid var(--line);border-radius:13px;background:var(--surface);box-shadow:0 7px 22px var(--accent-soft)}.ocr-toolbar>div{display:flex;gap:7px}.ocr-toolbar button{display:inline-flex;min-height:37px;align-items:center;gap:7px}.ocr-toolbar label{display:grid;gap:5px}.ocr-toolbar label>span{color:var(--muted);font:700 8px var(--font-mono);letter-spacing:.08em}.ocr-toolbar select{min-height:37px;padding:0 34px 0 11px;border:1px solid var(--line-strong);border-radius:8px;outline:0;color:var(--text-secondary);background:var(--surface);font:600 10px var(--font-ui)}.ocr-toolbar select:focus-visible{border-color:var(--green);box-shadow:0 0 0 3px var(--accent-soft)}.ocr-run{justify-content:center;padding:0 14px;border:1px solid var(--green-strong);border-radius:8px;color:var(--fg);background:var(--green-strong);font:700 10px var(--font-ui)}.ocr-run kbd{margin-left:4px;color:var(--fg);background:transparent;font:8px var(--font-mono)}.ocr-run:disabled{border-color:var(--line-strong);color:var(--muted);background:var(--surface-2)}
.ocr-stage{display:grid;grid-template-columns:minmax(320px,.9fr) minmax(420px,1.1fr);gap:13px;min-height:520px}.ocr-source,.ocr-result{display:grid;min-width:0;overflow:hidden;padding:0}.ocr-source{grid-template-rows:auto minmax(0,1fr) auto}.ocr-result{grid-template-rows:auto auto minmax(0,1fr) auto}.ocr-source>header,.ocr-result>header{display:flex;min-height:63px;align-items:center;justify-content:space-between;padding:0 16px;border-bottom:1px solid var(--line-weak)}.ocr-source h3,.ocr-result h3{margin-top:3px;font:700 16px var(--font-display)}.ocr-source>header>button{display:grid;width:30px;height:30px;place-items:center;border:1px solid var(--line);border-radius:8px;color:var(--muted);background:transparent}.ocr-result>header>span{display:flex;align-items:center;gap:6px;padding:5px 8px;border-radius:999px;color:var(--muted);background:var(--surface-2);font:700 8px var(--font-ui)}.ocr-result>header>span i{width:6px;height:6px;border-radius:50%;background:var(--fg-3)}.ocr-result>header>span.ready{color:var(--accent);background:var(--accent-soft)}.ocr-result>header>span.ready i{background:var(--accent)}
.ocr-source__surface{display:grid;min-height:0;place-items:center;overflow:hidden;margin:13px;border:1px solid var(--accent-soft);border-radius:11px;outline:0;background:linear-gradient(145deg,var(--surface-2),var(--surface-2));cursor:context-menu}.ocr-source__surface:focus-visible{border-color:var(--green);box-shadow:0 0 0 3px var(--accent-soft)}.ocr-source__surface img{display:block;width:100%;height:100%;min-height:380px;object-fit:contain;background: var(--surface-2);background-position:0 0,0 7px,7px -7px,-7px 0;background-size:14px 14px}.ocr-source__surface.empty{cursor:pointer}.ocr-source__surface>div{display:grid;place-items:center;gap:7px;padding:28px;text-align:center}.ocr-source__surface>div>span{display:grid;width:52px;height:52px;place-items:center;border-radius:15px;color:var(--green-strong);background:var(--accent-soft)}.ocr-source__surface>div>b{margin-top:4px;font:700 14px var(--font-display)}.ocr-source__surface>div>p,.ocr-source__surface>div>small{color:var(--muted);font-size:9px}.ocr-source>footer,.ocr-result>footer{display:flex;min-height:61px;align-items:center;justify-content:space-between;gap:12px;padding:10px 15px;border-top:1px solid var(--line-weak)}.ocr-source>footer>span{display:grid;min-width:0;gap:3px}.ocr-source>footer b{overflow:hidden;font-size:10px;text-overflow:ellipsis;white-space:nowrap}.ocr-source>footer small{color:var(--muted);font-size:8.5px}
.ocr-result__meta{display:flex;align-items:center;justify-content:space-between;gap:14px;padding:9px 15px;border-bottom:1px solid var(--line-weak);color:var(--text-secondary);background:var(--surface-2);font-size:8.5px}.ocr-result__meta small{color:var(--muted)}.ocr-result textarea{box-sizing:border-box;width:calc(100% - 26px);min-height:376px;resize:none;margin:13px;padding:15px;border:1px solid var(--accent-soft);border-radius:10px;outline:0;color:var(--fg);background:var(--surface);font:11px/1.75 var(--font-mono);caret-color:var(--green-strong)}.ocr-result textarea:focus{border-color:var(--green);box-shadow:0 0 0 3px var(--accent-soft)}.ocr-result textarea::placeholder{color:var(--fg-3)}.ocr-result>footer>span{color:var(--muted);font:700 8px var(--font-mono)}.ocr-result>footer>div{display:flex;gap:6px}.ocr-result>footer button{display:inline-flex;align-items:center;gap:6px}
.ocr-privacy-strip{display:grid;grid-template-columns:auto 1fr auto;align-items:center;gap:11px;margin-top:13px;padding:12px 15px;border:1px solid var(--accent-soft);border-radius:11px;background:var(--accent-soft)}.ocr-privacy-strip>span{display:grid;width:31px;height:31px;place-items:center;border-radius:9px;color:var(--green-strong);background:var(--surface)}.ocr-privacy-strip b{font-size:9px}.ocr-privacy-strip p{margin-top:3px;color:var(--muted);font-size:8.5px;line-height:1.5}.ocr-privacy-strip>i{color:var(--green-strong);font:700 8px var(--font-mono);font-style:normal;letter-spacing:.09em}
.ocr-toolbar label>span,.ocr-run kbd,.ocr-result>header>span,.ocr-source>footer small,.ocr-result__meta,.ocr-result>footer>span,.ocr-privacy-strip p,.ocr-privacy-strip>i{font-size:9px}
.ocr-result__meta small{font-size:9px}
...
<style>
.ocr-context-menu{position:fixed;z-index:145;width:270px;overflow:hidden;border:1px solid var(--accent-soft);border-radius:12px;background:var(--surface);box-shadow:0 18px 52px var(--accent-soft);animation:ocr-menu-in .14s ease-out both}.ocr-context-menu>header{display:grid;gap:3px;padding:10px 12px 8px;border-bottom:1px solid var(--line-weak);background:linear-gradient(125deg,var(--green-bg),var(--surface-2))}.ocr-context-menu>header span{color:var(--green-strong);font:700 8px var(--font-mono);letter-spacing:.1em}.ocr-context-menu>header b{overflow:hidden;font:700 11px var(--font-ui);text-overflow:ellipsis;white-space:nowrap}.ocr-context-menu>button{display:flex;width:100%;min-height:38px;align-items:center;gap:9px;padding:0 12px;border:0;border-bottom:1px solid var(--line-weak);color:var(--text-secondary);background:transparent;font:640 9.5px var(--font-ui);text-align:left}.ocr-context-menu>button:last-child{border-bottom:0}.ocr-context-menu>button kbd{margin-left:auto;color:var(--muted);font:8px var(--font-mono)}.ocr-context-menu>button:hover,.ocr-context-menu>button:focus-visible{outline:0;color:var(--green-strong);background:var(--green-bg)}.ocr-context-menu>button:disabled{color:var(--line-strong);background:transparent}.ocr-context-menu>button.danger{color:var(--danger)}@keyframes ocr-menu-in{from{opacity:0;transform:translateY(-4px) scale(.985)}to{opacity:1;transform:none}}@media(prefers-reduced-motion:reduce){.ocr-context-menu{animation:none}}
.ocr-context-menu>header span,.ocr-context-menu>button kbd{font-size:9px}
</style>
