...
.ocr-toolbar{display:grid;grid-template-columns:auto minmax(240px,1fr) auto;align-items:end;gap:12px;margin:14px 0;padding:12px 14px;border:1px solid var(--line);border-radius:13px;background:var(--surface);box-shadow:0 7px 22px var(--accent-soft)}.ocr-toolbar>div{display:flex;gap:7px}.ocr-toolbar button{display:inline-flex;min-height:37px;align-items:center;gap:7px}.ocr-toolbar label{display:grid;gap:5px}.ocr-toolbar label>span{color:var(--muted);font:700 11px var(--font-mono);letter-spacing:.08em}.ocr-toolbar select{min-height:37px;padding:0 34px 0 11px;border:1px solid var(--line-strong);border-radius:8px;outline:0;color:var(--text-secondary);background:var(--surface);font:600 11px var(--font-ui)}.ocr-toolbar select:focus-visible{border-color:var(--green);box-shadow:0 0 0 3px var(--accent-soft)}.ocr-run{justify-content:center;padding:0 14px;border:1px solid var(--green-strong);border-radius:8px;color:var(--accent-fg);background:var(--accent-solid-hover);font:700 11px var(--font-ui)}.ocr-run kbd{margin-left:4px;color:var(--fg);background:transparent;font:11px var(--font-mono)}.ocr-run:disabled{border-color:var(--line-strong);color:var(--muted);background:var(--surface-2)}
