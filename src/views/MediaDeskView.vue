...
.media-desk__drop>i{margin-top:7px;color:var(--green-strong);font:700 9px var(--font-ui);font-style:normal}
...
.media-desk__operations b{width:41px;height:41px;font-size:9px;line-height:1.15;text-align:center}
.media-desk__operations strong{font-size:11px}.media-desk__operations small{font-size:9px}
.media-desk__operations i{grid-column:1/-1;max-width:none;overflow:hidden;font-size:9px;text-align:left;text-overflow:ellipsis;white-space:nowrap}
.media-desk__operations button:disabled i{color:var(--fg-3)}
.media-desk__engine small,.media-desk__workspace header p,.media-desk__operation>header>small,.media-desk__directory small,.media-desk__result>b,.media-desk__result small,.media-desk__clip>header small,.media-desk__clip label span,.media-desk__clip p{font-size:9px}
...
.media-desk__progress span{display:grid;gap:3px;min-width:0}.media-desk__progress b{color:var(--text);font:700 10px var(--font-ui)}
.media-desk__progress small{overflow:hidden;font:9px var(--font-mono);line-height:1.4;text-overflow:ellipsis;white-space:nowrap}
...
.media-desk__clip{display:grid;gap:9px;margin-top:10px;padding:11px;border:1px solid color-mix(in srgb,var(--green) 24%,var(--line));border-radius:11px;background:color-mix(in srgb,var(--green-bg) 58%,var(--surface-raised))}.media-desk__clip>header{display:flex;justify-content:space-between}.media-desk__clip>header b{color:var(--text);font:700 10px var(--font-ui)}.media-desk__clip>header small{color:var(--green-strong);font:700 8px var(--font-mono)}.media-desk__clip>div{display:grid;grid-template-columns:1fr auto 1fr;gap:7px;align-items:end}.media-desk__clip label{display:grid;gap:4px}.media-desk__clip label span{color:var(--muted);font:700 8px var(--font-mono)}.media-desk__clip input{width:100%;min-width:0;height:32px;padding:0 8px;border:1px solid var(--line);border-radius:7px;background:var(--surface-raised);color:var(--text);font:700 10px var(--font-mono)}.media-desk__clip input:focus{border-color:var(--green);outline:2px solid color-mix(in srgb,var(--green) 25%,transparent);outline-offset:1px}.media-desk__clip>div>i{padding-bottom:8px;color:var(--muted);font:10px var(--font-mono);font-style:normal}.media-desk__clip figure{position:relative;height:5px;margin:0;border-radius:99px;background:var(--accent-soft)}.media-desk__clip figure span{position:absolute;top:0;bottom:0;left:var(--clip-start);right:calc(100% - var(--clip-end));min-width:3px;border-radius:inherit;background:var(--green)}.media-desk__clip p{min-height:24px;margin:0;color:var(--muted);font-size:8px;line-height:1.5}.media-desk__clip p.error{color:var(--danger)}
</style>
