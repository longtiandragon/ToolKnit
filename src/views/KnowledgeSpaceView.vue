...
.knowledge-space__hero>aside{display:grid;grid-template-rows:auto 1fr auto;padding:22px;border-left:1px solid var(--surface-2)}.knowledge-space__hero>aside>span{display:flex;align-items:center;gap:7px;font-size:11px}.knowledge-space__hero>aside>span i{width:7px;height:7px;box-shadow:0 0 0 4px var(--accent-soft)}.knowledge-space__hero>aside>span i.warning{}.knowledge-space__hero>aside>div{align-self:center;display:grid}.knowledge-space__hero>aside>div b{font:760 50px/1 var(--font-mono);letter-spacing:-.07em}.knowledge-space__hero>aside>div small{margin-top:5px;font:11px var(--font-mono);letter-spacing:.09em}.knowledge-space__hero>aside footer{display:grid;grid-template-columns:1fr 1fr;padding-top:13px;border-top:1px solid var(--surface-2);font-size:11px}.knowledge-space__hero>aside footer span+span{padding-left:13px;border-left:1px solid var(--surface-2)}.knowledge-space__hero>aside footer strong{display:block;margin-bottom:3px;font:700 16px var(--font-mono)}
.knowledge-space__areas{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:9px;padding:17px 0}.knowledge-space__areas>a{display:grid;grid-template-columns:34px minmax(0,1fr) auto;align-items:center;gap:10px;min-height:64px;padding:10px 12px;border:1px solid var(--line);border-radius:13px;color:var(--text-secondary);background:var(--surface-2);box-shadow:0 6px 18px var(--accent-soft)}.knowledge-space__areas>a:hover,.knowledge-space__areas>a:focus-visible{border-color:var(--accent);color:var(--green-strong);background:var(--surface)}.knowledge-space__areas>a>span{display:grid;width:34px;height:34px;place-items:center;border-radius:10px;color:var(--green-strong);background:var(--green-bg)}.knowledge-space__areas>a>div{display:grid;min-width:0;gap:3px}.knowledge-space__areas b,.knowledge-space__areas small{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.knowledge-space__areas b{font:680 11px var(--font-ui)}.knowledge-space__areas small{color:var(--muted);font-size:11px}.knowledge-space__areas strong{color:var(--green-strong);font:720 17px var(--font-mono)}
.knowledge-space__starts{display:grid;grid-template-columns:250px minmax(0,1fr);gap:10px;margin:0 0 14px}.knowledge-space__starts>header{display:flex;align-items:flex-start;flex-direction:column;justify-content:center;padding:13px 15px;border:1px solid var(--accent-soft);border-radius:14px;background:linear-gradient(135deg,var(--green-bg),var(--surface))}.knowledge-space__starts h3{margin-top:5px;font:700 15px/1.25 var(--font-display);letter-spacing:-.02em}.knowledge-space__starts>header>p:last-child{margin:7px 0 0;color:var(--muted);font-size:11px;line-height:1.5}.knowledge-space__starts>nav{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:1px;overflow:hidden;border:1px solid var(--line);border-radius:14px;background:var(--line);box-shadow:0 8px 22px var(--accent-soft)}.knowledge-space__starts a{display:grid;grid-template-columns:28px minmax(0,1fr) auto;align-items:center;gap:8px;min-height:55px;padding:8px 9px;color:var(--text);background:var(--surface);outline:0}.knowledge-space__starts a:hover,.knowledge-space__starts a:focus-visible{color:var(--green-strong);background:var(--green-bg)}.knowledge-space__starts a:focus-visible{box-shadow:inset 0 0 0 2px color-mix(in srgb,var(--green) 48%,transparent)}.knowledge-space__starts a>span{display:grid;width:28px;height:28px;place-items:center;border:1px solid var(--accent-soft);border-radius:8px;color:var(--green-strong);background:var(--surface)}.knowledge-space__starts a>div{display:grid;min-width:0;gap:3px}.knowledge-space__starts b,.knowledge-space__starts small{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.knowledge-space__starts b{font:670 11px var(--font-ui)}.knowledge-space__starts small{color:var(--muted);font-size:11px}.knowledge-space__starts a>.app-icon{color:var(--muted)}
.knowledge-space__body{display:grid;grid-template-columns:minmax(0,1fr) 294px;gap:14px;align-items:start}.knowledge-space__body>main,.knowledge-space__side>section{overflow:hidden;border:1px solid var(--line);border-radius:16px;background:var(--surface-2);box-shadow:0 12px 30px var(--accent-soft)}.knowledge-space__toolbar{display:grid;grid-template-columns:minmax(240px,1fr) auto;align-items:center;gap:8px 10px;padding:13px;border-bottom:1px solid var(--line-weak)}.knowledge-space__toolbar label{display:flex;min-width:0;align-items:center;gap:8px;height:38px;padding:0 11px;border:1px solid var(--line);border-radius:10px;color:var(--muted);background:var(--canvas)}.knowledge-space__toolbar label:focus-within{border-color:var(--green);box-shadow:0 0 0 3px color-mix(in srgb,var(--green) 12%,transparent)}.knowledge-space__toolbar input{min-width:0;flex:1;border:0;outline:0;color:var(--text);background:transparent;font-size:11px}.knowledge-space__toolbar label button{width:24px;height:24px;padding:0;border:0;color:var(--muted);background:transparent}.knowledge-space__toolbar nav{display:flex;grid-row:2;grid-column:1/-1;gap:3px;overflow-x:auto;scrollbar-width:thin}.knowledge-space__toolbar nav button{min-height:30px;flex:0 0 auto;padding:0 7px;border:1px solid transparent;border-radius:7px;color:var(--muted);background:transparent;font-size:11px;white-space:nowrap}.knowledge-space__toolbar nav button:hover,.knowledge-space__toolbar nav button.active{border-color:var(--accent-soft);color:var(--green-strong);background:var(--green-bg)}.knowledge-space__toolbar>small{grid-row:1;grid-column:2;color:var(--muted);font:11px var(--font-mono);white-space:nowrap}
.knowledge-space__search-notice{display:flex;align-items:center;gap:7px;margin:0;padding:9px 14px;border-bottom:1px solid var(--warn-soft);color:var(--danger);background:var(--warn-soft);font-size:11px}.knowledge-space__searching{display:flex;min-height:248px;align-items:center;justify-content:center;gap:13px;padding:34px;color:var(--muted)}.knowledge-space__searching>span{width:18px;height:18px;border:2px solid var(--accent-soft);border-top-color:var(--green);border-radius:50%;animation:knowledge-search-spin .8s linear infinite}.knowledge-space__searching>div{display:grid;gap:4px}.knowledge-space__searching b{color:var(--text);font-size:12px}.knowledge-space__searching small{max-width:410px;font-size:11px;line-height:1.5}@keyframes knowledge-search-spin{to{transform:rotate(1turn)}}
.knowledge-space__items{display:grid;padding:5px 13px 9px}.knowledge-space__item{display:grid;grid-template-columns:34px minmax(0,1fr) auto 42px;align-items:center;gap:10px;min-height:66px;padding:9px;border-bottom:1px solid var(--line-weak);color:var(--text);cursor:context-menu}.knowledge-space__item:hover,.knowledge-space__item:focus-visible{color:var(--green-strong);background:linear-gradient(90deg,var(--green-bg),transparent)}.knowledge-space__item:focus-visible{outline:2px solid color-mix(in srgb,var(--green) 46%,transparent);outline-offset:-2px}.knowledge-space__item>span{display:grid;width:33px;height:33px;place-items:center;border-radius:9px;color:var(--green-strong);background:var(--accent-soft)}.knowledge-space__item>div{display:grid;min-width:0;gap:4px}.knowledge-space__item b,.knowledge-space__item small{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.knowledge-space__item b{font:670 11px var(--font-ui)}.knowledge-space__item small{color:var(--muted);font-size:11px}.knowledge-space__item>i{padding:3px 6px;border-radius:5px;color:var(--green-strong);background:var(--green-bg);font:11px var(--font-ui);font-style:normal}.knowledge-space__item time{color:var(--muted);font:11px var(--font-mono);text-align:right}.knowledge-space__empty{display:grid;min-height:300px;place-content:center;justify-items:center;padding:36px;color:var(--muted);text-align:center}.knowledge-space__empty>span{display:grid;width:46px;height:46px;margin-bottom:12px;place-items:center;border-radius:14px;color:var(--green-strong);background:var(--green-bg)}.knowledge-space__empty b{color:var(--text);font:700 15px var(--font-ui)}.knowledge-space__empty p{max-width:340px;margin:7px 0 14px;font-size:11px;line-height:1.6}
.knowledge-space__match{overflow:hidden;margin:0;color:var(--text-secondary);font:11px/1.45 var(--font-ui);text-overflow:ellipsis;white-space:nowrap}.knowledge-space__match mark{padding:1px 2px;border-radius:3px;color:var(--accent);background:var(--accent-soft);font-weight:750}@media(prefers-reduced-motion:reduce){.knowledge-space__searching>span{animation:none;border-color:var(--accent-soft);border-top-color:var(--green)}}
.knowledge-space__side{display:grid;gap:11px}.knowledge-space__side>section>header{display:flex;align-items:flex-end;justify-content:space-between;gap:10px;padding:13px;border-bottom:1px solid var(--line-weak)}.knowledge-space__side h3{margin-top:4px;font:700 14px var(--font-display)}.knowledge-space__side>section>header>a{color:var(--green-strong);font-size:11px}.knowledge-space__side>section>a{display:grid;grid-template-columns:29px minmax(0,1fr) auto;align-items:center;gap:8px;min-height:56px;padding:8px 11px;border-bottom:1px solid var(--line-weak);color:var(--text)}.knowledge-space__side>section>a:hover,.knowledge-space__side>section>a:focus-visible{color:var(--green-strong);background:var(--green-bg)}.knowledge-space__side>section>a>span{display:grid;width:29px;height:29px;place-items:center;border-radius:8px;color:var(--green-strong);background:var(--accent-soft)}.knowledge-space__side>section>a>div{display:grid;min-width:0;gap:3px}.knowledge-space__side>section>a b,.knowledge-space__side>section>a small{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.knowledge-space__side>section>a b{font-size:11px}.knowledge-space__side>section>a small{color:var(--muted);font-size:11px}.knowledge-space__health>div{display:grid;grid-template-columns:42px minmax(0,1fr);align-items:center;gap:9px;padding:11px 13px;border-bottom:1px solid var(--line-weak)}.knowledge-space__health>div:last-child{border-bottom:0}.knowledge-space__health>div>span{position:relative;display:block;width:40px;height:5px;overflow:hidden;border-radius:9px;background:var(--surface-2)}.knowledge-space__health>div>span i{position:absolute;inset:0 auto 0 0;width:var(--value);border-radius:inherit;background:var(--green)}.knowledge-space__health p{display:grid;gap:3px;margin:0}.knowledge-space__health b{font-size:11px}.knowledge-space__health small{color:var(--muted);font-size:11px;line-height:1.4}
.knowledge-space__menu{position:fixed;z-index:145;width:252px;overflow:hidden;border:1px solid var(--accent-soft);border-radius:12px;background:var(--surface);box-shadow:var(--shadow-lg);animation:knowledge-menu-in .14s ease-out both}.knowledge-space__menu>header{display:grid;gap:3px;padding:11px 13px 9px;border-bottom:1px solid var(--line-weak);background:linear-gradient(125deg,var(--green-bg),var(--surface-2))}.knowledge-space__menu>header span{color:var(--green-strong);font:700 11px var(--font-mono);letter-spacing:.1em}.knowledge-space__menu>header b{overflow:hidden;font:700 12px var(--font-ui);text-overflow:ellipsis;white-space:nowrap}.knowledge-space__menu button{display:flex;width:100%;min-height:39px;align-items:center;gap:9px;padding:0 13px;border:0;border-bottom:1px solid var(--line-weak);color:var(--text-secondary);background:transparent;font:650 11px var(--font-ui);text-align:left}.knowledge-space__menu button:last-child{border-bottom:0}.knowledge-space__menu button:hover,.knowledge-space__menu button:focus-visible{color:var(--green-strong);background:var(--green-bg)}.knowledge-space__menu button:focus-visible{outline:2px solid color-mix(in srgb,var(--green) 48%,transparent);outline-offset:-2px}@keyframes knowledge-menu-in{from{opacity:0;transform:translateY(-4px) scale(.985)}to{opacity:1;transform:none}}
.knowledge-space__area-menu{position:fixed;z-index:145;width:268px;overflow:hidden;border:1px solid var(--accent-soft);border-radius:13px;background:var(--surface);box-shadow:var(--shadow-lg);animation:knowledge-menu-in .14s ease-out both}.knowledge-space__area-menu>header{display:grid;gap:3px;padding:11px 13px 9px;border-bottom:1px solid var(--line-weak);background:linear-gradient(125deg,var(--green-bg),var(--surface-2))}.knowledge-space__area-menu>header span{color:var(--green-strong);font:700 11px var(--font-mono);letter-spacing:.08em}.knowledge-space__area-menu>header b{font:700 13px var(--font-ui)}.knowledge-space__area-menu>button{display:grid;width:100%;min-height:52px;grid-template-columns:25px minmax(0,1fr) auto;align-items:center;gap:8px;padding:7px 12px;border:0;border-bottom:1px solid var(--line-weak);color:var(--text-secondary);background:transparent;text-align:left}.knowledge-space__area-menu>button:last-child{border-bottom:0}.knowledge-space__area-menu>button:hover,.knowledge-space__area-menu>button:focus-visible{color:var(--green-strong);background:var(--green-bg)}.knowledge-space__area-menu>button:focus-visible{outline:2px solid color-mix(in srgb,var(--green) 48%,transparent);outline-offset:-2px}.knowledge-space__area-menu>button>span{display:grid;min-width:0;gap:3px}.knowledge-space__area-menu>button b,.knowledge-space__area-menu>button small{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.knowledge-space__area-menu>button b{font:660 11px var(--font-ui)}.knowledge-space__area-menu>button small{color:var(--muted);font-size:11px}
.knowledge-space__intro>p:not(.eyebrow){color:var(--fg);font-size:13px}
.knowledge-space__hero>aside>span{font-size:11px}.knowledge-space__hero>aside>div small{font-size:11px}.knowledge-space__hero>aside footer{font-size:11px}
.knowledge-space__areas b{font-size:12px}.knowledge-space__areas small{font-size:11px}
.knowledge-space__starts>header>p:last-child{font-size:11px;line-height:1.55}.knowledge-space__starts b{font-size:11px}.knowledge-space__starts small{font-size:11px}
.knowledge-space__toolbar input{font-size:12px}.knowledge-space__toolbar nav button,.knowledge-space__toolbar>small{font-size:11px}
.knowledge-space__search-notice{font-size:11px}.knowledge-space__searching small{font-size:11px;line-height:1.55}
.knowledge-space__item{cursor:pointer}.knowledge-space__item b{font-size:12px}.knowledge-space__item small{font-size:11px}.knowledge-space__item>i,.knowledge-space__item time{font-size:11px}.knowledge-space__match{font-size:11px;line-height:1.5}.knowledge-space__empty p{font-size:11px}
.knowledge-space__side>section>header>a{font-size:11px}.knowledge-space__side>section>a b{font-size:11px}.knowledge-space__side>section>a small,.knowledge-space__health small{font-size:11px}.knowledge-space__health b{font-size:11px}
.knowledge-space__menu>header span,.knowledge-space__area-menu>header span{font-size:11px}.knowledge-space__menu button{font-size:11px}.knowledge-space__area-menu>button b{font-size:12px}.knowledge-space__area-menu>button small{font-size:11px}
