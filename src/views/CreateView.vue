...
.create-space__recent>header{display:flex;align-items:flex-start;justify-content:space-between;gap:10px;padding-bottom:13px;border-bottom:1px solid var(--surface-2)}.create-space__recent>header div{display:grid;gap:3px}.create-space__recent>header span{color:var(--accent);font:700 11px var(--font-mono);letter-spacing:.11em}.create-space__recent>header b{color:var(--fg);font:680 14px var(--font-ui)}.create-space__recent>header small{color:var(--fg);font:11px var(--font-mono)}
.create-space__recent-list{display:grid;align-content:start}.create-space__recent-list>a{display:flex;min-width:0;align-items:center;justify-content:space-between;gap:13px;padding:11px 2px;border-bottom:1px solid var(--surface-2);color:var(--fg)}.create-space__recent-list>a:hover,.create-space__recent-list>a:focus-visible{padding-left:7px;color:var(--accent);background:var(--surface-2)}.create-space__recent-list span{display:grid;min-width:0;gap:3px}.create-space__recent-list b,.create-space__recent-list small{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.create-space__recent-list b{font:650 11px var(--font-ui)}.create-space__recent-list small{color:var(--fg);font-size:11px}.create-space__recent-list time{display:grid;flex:0 0 auto;justify-items:end;gap:3px;color:var(--fg);font:11px var(--font-mono)}.create-space__recent-list time span{color:var(--accent);font:700 11px var(--font-ui)}
.create-space__recent-empty{display:flex;align-items:center;justify-content:center;gap:11px;color:var(--accent)}.create-space__recent-empty span{display:grid;gap:3px}.create-space__recent-empty b{color:var(--fg);font-size:11px}.create-space__recent-empty small{color:var(--fg);font-size:11px}
...
.create-space__recent>header span{font-size:11px}.create-space__recent>header small{font-size:11px}.create-space__recent-list b{font-size:12px}.create-space__recent-list small,.create-space__recent-list time,.create-space__recent-list time span{font-size:11px}.create-space__recent-empty b{font-size:12px}.create-space__recent-empty small{font-size:11px}
.create-quick-starts>a{min-height:68px}.create-quick-starts b{font-size:12px}.create-quick-starts small{display:-webkit-box;overflow:hidden;font-size:11px;line-height:1.35;white-space:normal;-webkit-box-orient:vertical;-webkit-line-clamp:2}
.create-space__section-heading>p{font-size:11px}.create-workflow{cursor:pointer}.create-workflow>header p,.create-workflow>header small{font-size:11px}.create-workflow>div p{font-size:12px}.create-workflow>footer{font-size:11px}
.create-workflow-menu>header span{font-size:11px}.create-workflow-menu button b{font-size:12px}.create-workflow-menu button small{font-size:11px}
