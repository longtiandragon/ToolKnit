...
.ai-workbench__hero>aside{position:relative;z-index:1;display:grid;align-content:center;gap:6px;padding:25px;border-left:1px solid var(--surface-2);}.ai-workbench__hero>aside>span{display:flex;align-items:center;gap:7px;font:700 11px var(--font-mono);letter-spacing:.06em}.ai-workbench__hero>aside strong{margin-top:5px;font:700 20px var(--font-display)}.ai-workbench__hero>aside small{overflow:hidden;font:11px/1.5 var(--font-mono);text-overflow:ellipsis;white-space:nowrap}.ai-workbench__hero>aside a{display:flex;width:max-content;align-items:center;gap:6px;margin-top:8px;font:700 11px var(--font-ui)}.ai-workbench__hero>aside a:hover{}
...
.ai-workbench__composer-status>span{padding:4px 7px;border-radius:999px;color:var(--green-strong);background:var(--green-bg);font:700 11px var(--font-mono)}
.ai-workbench__composer-status>span.warning{color:var(--warn);background:var(--warn-soft)}
.ai-workbench__composer-status .primary-button{min-height:31px;padding-inline:9px;font-size:11px}
...
.ai-workbench__actions nav small,.ai-workbench__actions>footer label,.ai-workbench__payload summary small,.ai-workbench__payload>div>header,.ai-workbench__composer>footer small,.ai-workbench__running small,.ai-workbench__result>header>span,.ai-workbench__result>footer>span{font-size:11px}
.ai-workbench__payload>div button,.ai-workbench__empty>span{font-size:11px}
</style>
