...
export const toolCatalog: ToolCatalogItem[] = [
  ...
  { id: 'developer-uuid', title: 'UUID / ULID / 随机', description: '生成 ID、密码或临时令牌', group: '开发', icon: 'fingerprint', to: { path: '/developer-tools', query: { tool: 'uuid' } }, keywords: ['guid', 'random', '唯一标识', 'ulid', '密码'] },
