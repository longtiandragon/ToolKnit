...
export const toolCatalog: ToolCatalogItem[] = [
  ...
  fileTool('watermark', 'PDF 添加水印', '文字水印', 'pdf', 'watermark', ['watermark', '版权']),
  fileTool('edit-bookmarks', 'PDF 书签', '书签签名', 'pdf', 'list', ['书签', '签名']),
  fileTool('page-number', 'PDF 添加页码', '设置起始数字和页码位置', 'pdf', 'number', ['编号', 'page number']),
  fileTool('images-to-pdf', '图片转 PDF', '图片合成 PDF', 'pdf', 'file-image', ['照片', 'image to pdf']),
  fileTool('pdf-to-image', 'PDF 转图片', '每页导出图片', 'pdf', 'image', ['png', 'jpg', 'webp', 'pdf to image']),
  ...
  { id: 'organize-dedupe-report', title: '文件去重扫描', description: '精确重复、相似图片、目录对比与清单验证', group: '整理', icon: 'search', to: { path: '/tools', query: { mode: 'file-health' } }, keywords: ['查重', '去重', '相似图片', '图片相似', '对比', '清单', 'sha256', 'Czkawka'] },
  ...
  { id: 'developer-hash', title: 'SHA-256 文本哈希', description: '生成十六进制指纹', group: '开发', icon: 'hash', to: { path: '/developer-tools', query: { tool: 'hash' } }, keywords: ['sha256', 'hash', '校验'] },
  { id: 'developer-uuid', title: 'UUID / ULID / 随机', description: '生成 ID、密码', group: '开发', icon: 'fingerprint', to: { path: '/developer-tools', query: { tool: 'uuid' } }, keywords: ['guid', 'random', '唯一标识', 'ulid', '密码'] },
  { id: 'developer-timestamp', title: '时间戳转换', description: '秒/毫秒与日期互转', group: '开发', icon: 'clock', to: { path: '/developer-tools', query: { tool: 'timestamp' } }, keywords: ['timestamp', '日期'] },
  { id: 'developer-radix', title: '整数进制转换', description: '2 到 36 进制', group: '开发', icon: 'binary', to: { path: '/developer-tools', query: { tool: 'radix' } }, keywords: ['binary', 'hex', '进制'] },
  { id: 'developer-headers', title: 'HTTP Headers', description: '请求/响应头', group: '开发', icon: 'link', to: { path: '/developer-tools', query: { tool: 'headers' } }, keywords: ['http', 'cors', 'csp'] },
