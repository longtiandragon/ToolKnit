...
export const toolCatalog: ToolCatalogItem[] = [
  ...
  fileTool('signature', 'PDF 放置可视签名', '把手写风格签名图层放到每页底部；不是数字证书签名', 'pdf', 'pen', ['签名', '手写签名', '可视签名', 'signature']),
  fileTool('bookmarks', '导出 PDF 书签', '把书签层级、样式和链接导出为受控 JSON', 'pdf', 'list', ['书签', '目录', 'outline', 'bookmark']),
  fileTool('edit-bookmarks', '编辑 PDF 书签', '用受控 JSON 替换书签树并设置页码跳转', 'pdf', 'edit', ['书签', '目录', '编辑目录', 'outline', 'bookmark']),
