...
export const toolCatalog: ToolCatalogItem[] = [
  ...
  { id: 'media-desk', title: '音视频转换', description: '桌面端调用本机 FFmpeg，转换、提取和管理媒体轨道', group: '媒体', icon: 'play', to: { path: '/media' }, keywords: ['视频', '音频', 'mp3', 'mp4', 'm4a', 'ffmpeg', '提取音频', '移除音轨', '移除字幕', '加入字幕'] },
  ...
  { id: 'organize-dedupe-report', title: '文件去重扫描', description: '健康与目录对比', group: '整理', icon: 'search', to: { path: '/tools', query: { mode: 'file-health' } }, keywords: ['查重', '去重', '对比'] },
