...
export type PdfTaskOperation = 'merge' | 'split' | 'compare' | 'rotate' | 'extract' | 'reorder' | 'watermark' | 'page-number' | 'crop' | 'text' | 'attachments' | 'bookmarks' | 'metadata' | 'pdf-to-image' | 'compress' | 'redact' | 'ocr'
